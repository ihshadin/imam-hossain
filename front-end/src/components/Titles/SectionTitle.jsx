    ...
    <div className="py-5">
      <div className="relative flex flex-row gap-10 justify-between items-start md:items-center z-0 pl-5">
        <div className="pr-5 md:pr-10 py-2 relative inline-block skew-x-[-20deg] bg-secondary dark:bg-white">
          ...
          <h2 className="pl-7 lg:pl-10 font-bold text-[22px] lg:text-4xl leading-[1em] skew-x-[20deg] whitespace-nowrap line-clamp-1 text-white dark:text-secondary">
            {title}
          </h2>
        ...
        {btnText && (
          <Link
            href={btnLink || "#"}
            className="flex items-center justify-end gap-1 font-semibold absolute right-0 top-1/2 -translate-y-1/2"
          >
